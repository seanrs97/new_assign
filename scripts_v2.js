...
if(newsContainer){
    fetch("https://newsapi.org/v1/articles?source=bbc-news&apiKey=c5b2ba3cfb4c4717852bf328348da961")
    .then(response => {
        return response.json();
    }).then(news => {
...
if(askJackForm){
    const askJackFormSubmit = e => {
        ...
        fetch("https://jgawlik83.github.io/service_workers_3/", {mode: "no-cors", method: "POST", body: contact})
        .then(response => {
